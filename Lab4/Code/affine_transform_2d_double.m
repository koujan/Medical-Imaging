...
% Make center of the image coordinates 0,0 #(this is the center of rotation, center of the output image)
xd=x-mean_out(1);
yd=y-mean_out(2);

% Calculate the Transformed coordinates  #(Here is the "Transform block" )
